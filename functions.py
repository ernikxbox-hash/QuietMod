...
CMD_FEATURES: dict[str, dict] = {
    ...
    "online": {
        "title": "💡 .online",
        "desc": "Бесконечный онлайн — бот автоматически поддерживает твой статус онлайн 24/7 во всех чатах.",
        "usage": ".online — включить · .offline — выключить",
        "example": ".online",
        "note": "Напиши в ЛС с ботом — и ты онлайн для всех своих собеседников хоть круглосуточно"
    },
    "curs": {
        "title": "💱 .curs",
